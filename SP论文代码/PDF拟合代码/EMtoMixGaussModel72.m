...
% 二混合高斯噪声
% orders=2;
% MIU=[-0.2 0.2];%一开始随机给的均值
% SIGMA=[0.01 0.01];%一开始随机给的方差，注意是方差
...
% 四混合高斯噪声
orders=4;
MIU=[-0.4 -0.2 0.2 0.4];%一开始随机给的均值
SIGMA=[0.01 0.02 0.02 0.01];%一开始随机给的方差
WEIGHT=[0.3 0.2 0.2 0.3];%一开始随机给的权重

% % 五混合高斯噪声
% orders=5;
% MIU=[0 0 0 0 0];%一开始随机给的均值
% SIGMA=[1 9 16 25 36];%一开始随机给的方差
% WEIGHT=ones(1,orders)/orders;%一开始随机给的权重
%% 正式进行EM估计
